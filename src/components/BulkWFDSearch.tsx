      ...
      {results.existing.length > 0 && (
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium text-gray-900">Existing WFD Questions</h3>
            <button
              onClick={() => {
                ...
                link.setAttribute('download', 'wfd_search_results.csv');
